 ...
 */
public class ChatAnimButton extends android.support.v7.widget.AppCompatImageButton {
    ...
    public ChatAnimButton(Context context) {
        super(context);
    }

    public ChatAnimButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ChatAnimButton(Context context, AttributeSet attrs, int defStyleAttr) {
